...
class StickyNote(QMainWindow):
    ...
    def refresh_ui(self):
        self.tree_logic.refresh_ui_from_data()
    ...
    def toggle_lock_mode(self):
        self.win_logic.toggle_lock_mode()

    # Events
    def mousePressEvent(self, e):
        self.win_logic.mousePressEvent(e)

    def mouseMoveEvent(self, e):
        self.win_logic.mouseMoveEvent(e)

    def mouseReleaseEvent(self, e):
        self.win_logic.mouseReleaseEvent(e)
    ...
    def keyPressEvent(self, e):
        if not self.locked and e.key() == Qt.Key.Key_Delete:
            ...
            if item:
                self.tree_logic.delete_item(item)
        super().keyPressEvent(e)

    def load_from_file(self):
        self.data.load_from_file()
        if self.data.current_note_id:
            self.refresh_ui()
