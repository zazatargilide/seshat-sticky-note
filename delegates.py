...
class DateDelegate(QStyledItemDelegate):
    ...
    def paint(self, painter, option, index):
        ...
        check_rect = style.subElementRect(
            QStyle.SubElement.SE_ItemViewItemCheckIndicator, opt, tree_widget
        )
        ...
        style.drawPrimitive(
            QStyle.PrimitiveElement.PE_IndicatorItemViewItemCheck, check_opt, painter, tree_widget
        )
        ...
        elided_text = painter.fontMetrics().elidedText(
            main_text, Qt.TextElideMode.ElideRight, text_rect.width()
        )
        painter.drawText(
            text_rect, Qt.AlignmentFlag.AlignLeft | Qt.AlignmentFlag.AlignVCenter, elided_text
        )
