...
class WindowLogic:
    ...
    def toggle_lock_mode(self):
        ...
        if self.mw.locked:
            ...
            self.mw.inp.hide()
            self.mw.lock_btn.hide()
            self.mw.grip_indicator.hide()
            self.mw.menu_btn.hide()
            self.mw.close_btn.hide()
            ...
            self.mw.inp.show()
            self.mw.lock_btn.show()
            self.mw.grip_indicator.show()
            self.mw.menu_btn.show()
            self.mw.close_btn.show()
    ...
    def resizeEvent(self, event):
        ...
        self.mw.grip_indicator.move(
            rect.right() - grip_w - padding_x, rect.bottom() - grip_h - padding_y
        )
