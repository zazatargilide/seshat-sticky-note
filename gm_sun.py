...
class SunItem(QGraphicsItem):
    ...
    def paint(self, painter, option, widget):
        ...
        # --- 1. СВЕЧЕНИЕ ---
        layers = [(1.8, 0.4, 0.05), (1.5, 0.7, 0.08), (1.2, 1.0, 0.10)]
        ...
        bg_pen = QPen(QBrush(bg_grad), pen_width)
        ...
        if self.progress > 0:
            ...
            prog_pen = QPen(QBrush(prog_grad), pen_width)
        ...
        # --- 3. ЯДРО ---
        core_rect = ring_rect.adjusted(
            pen_width / 2 + 10, pen_width / 2 + 10, -pen_width / 2 - 10, -pen_width / 2 - 10
        )
        ...
        # Рисуем по центру
        painter.drawText(
            core_rect, Qt.AlignmentFlag.AlignCenter | Qt.AlignmentFlag.AlignVCenter, elided_title
        )
